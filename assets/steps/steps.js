! function(t, e) {
    ...
    window.Element.prototype.matches || (n = window.Element.prototype.msMatchesSelector || window.Element.prototype.webkitMatchesSelector), window.Element.prototype.closest || (r = function(t, e) {
        ...
        return null
    }), window.Event && "function" == typeof window.Event || (o = function(t, e) {
        e = e || {};
    ...
    var c = ".step",
        ...
        m = function(t, e) {
            if (!t.classList.contains(u)) {
                ...
                s.length && s[0].classList.remove(u), e.forEach(function(t) {
        ...
        L = function(e, t) {
            if (!e.classList.contains(u)) {
                ...
                if (n.length && (n[0].classList.remove(u), n[0].classList.remove(p)), e.classList.contains(f)) {
                    ...
                    }), n.length && n[0].classList.add(h), e.classList.add(u), w(e, s)
        ...
        w = function(t, e) {
            ...
            t.addEventListener(_, i), window.setTimeout(function() {
    ...
    return function() {
        function t(t, e) {
			...
			var curr = localStorage.getItem("stepsDone") ? localStorage.getItem("stepsDone") : 0;
			
//			var curr = $("#customIndex").val();
			
			
            void 0 === e && (e = {}), this._element = t, this._currentIndex = parseInt(curr), this._stepsContents = [], this._steps = [].slice.call(this._element.querySelectorAll(c)).filter(function(t) {
            ...
            }), this.options = i({}, b, e), this.options.linear && this._element.classList.add(d), n = this._stepsContents, this.options.animation && n.forEach(function(t) {
                t.classList.add(f), t.classList.add(h)
            }), this._steps.length && (m(this._steps[this._currentIndex], this._steps), L(this._stepsContents[this._currentIndex], this._stepsContents)), this._setLinkListeners(), Object.defineProperty(this._element, v, {
                value: this,
                writable: !0
            })
        }
        var e = t.prototype;
        return e._setLinkListeners = function() {
            var n = this;
            this._steps.forEach(function(t) {
                var e = t.querySelector(a);
            ...
            }), this._element[v] = void 0, this._element = void 0, this._currentIndex = void 0, this._steps = void 0, this._stepsContents = void 0
        }, t
    }()
});