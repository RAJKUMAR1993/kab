                                        ...
                                        <div class="clearfix">
                                            ...
                                            <div class="number float-right text-right">
                                                ...
                                                <span class="font700"><?php 
													$tamount = $this->db->select_sum("total_amount")->get_where("tbl_orders",["session_organized_by"=>"speaker","creator_id"=>$this->session->userdata['speaker_id']])->row();
                                    ...
                                    <form method="get" id="configform" >
                                        ...
                                        <div class="col-md-2" style="margin:21px">
                                            <button type="submit" class="btn btn-info waves-effect waves-light m-t-30" style="margin-top: inherit;">Submit</button>
                                            	<a href="<? echo base_url('speaker/payments') ?>" class="btn btn-warning waves-effect waves-light m-t-30" style="margin-top: inherit;">Reset</a>
                                        </div> 
						            </form>
                            </div>
                        <div class="header">
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo date("d-m-Y",strtotime($sesdata->spe_se_date)); ?></td>
