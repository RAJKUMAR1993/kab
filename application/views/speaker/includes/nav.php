 <nav class="navbar navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="navbar-brand">
                    <a href="<?php echo base_url("speaker/dashboard");?>">
                                        ...
                                        <div class="dropdown-menu animated flipInY user-profile">
                                            <div class="d-flex p-3 align-items-center">
                                                ...
                                                <div class="drop-right">
                                                    <h4><?php echo $this->session->userdata('speaker_name');?></h4>
                                                    <p class="user-name"><?php echo $this->session->userdata('email');?></p>
                                                </div>
                                            </div>
                                            <div class="m-t-10 p-3 drop-list">
                                                <ul class="list-unstyled">
                                                    <li><a href="<?php echo base_url("speaker/settings/basic");?>"><i class="icon-user"></i>My Profile</a></li>
                                                    <li><a href="<?php echo base_url(); ?>speaker/settings/changepassword"><i class="icon-key"></i>Change Password</a></li>
                                                    <li class="divider"></li>
                                                    <li><a href="<?php echo base_url("speaker/login/logout");?>"><i class="icon-power"></i>Logout</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
