    ...
    <a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/udema/img/logo.png" width="150px" height="55px" data-retina="true" alt=""></a>
            ...
            <div class="alert alert-danger" style="display:none" id="emsg"></div>
			  <form id="studentlogin">
				...
				<small><a href="<?php echo base_url('student/login/forgot');?>">Forgot password?</a></small>
				<button type="submit" class="btn_1 rounded full-width add_top_60">Login</button>
				<div class="text-center add_top_10">New to Kab? <strong><a href="<?php echo base_url('student/registration');?>">Sign up!</a></strong></div>
			</form>
