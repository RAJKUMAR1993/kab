	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle auth-main">
				<div class="auth-box" >
                    <div class="mobile-logo"><a href="student/login"><img src="<?php echo base_url();?>assets/images/logo-icon.svg" alt="KAB Education Fair"></a></div>
                    <div class="auth-left">
                        <div class="left-top">
                    ...
                    <div class="auth-right">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <!-- <form class="form-auth-small" action="<?php echo base_url("student/login/do_login");?>" method="POST"> -->
                                    ...
                                    <div class="bottom">
                                        <span class="helper-text m-b-10"><i class="fa fa-lock"></i> <a href="<?php echo base_url('student/login/forgot');?>">Forgot password?</a></span>
                                        <span>Don't have an account? <a href="<?php echo base_url('student/registration');?>">Register</a></span>
                                    </div>
                                </form>
                            </div>
                        </div>
