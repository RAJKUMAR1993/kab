                    ...
                    <div class="card top_report">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('counsellor/sessions');?>">
                                <div class="body">
                                    <div class="clearfix">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('counsellor/meetings');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-comments-o text-col-blue" style="font-size:25px;"></i>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('counsellor/reports/sessions_completed');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-comments-o text-col-blue" style="font-size:25px;"></i>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('counsellor/reports/sessions_tobecompleted');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                        ...
                                        <div class="number float-right text-right">
                                            <h6>Total Sessions In Progress</h6>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('counsellor/reports/sessions_na');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-comments-o text-col-green" style="font-size:25px;"></i>
                                        ...
                                        <div class="number float-right text-right">
                                            <h6>Total Sessions Not Attended</h6>
                                            <span class="font700"><?php echo $tnameetings;?></span>
                                        </div>
                                    </div>
                                    <div class="progress progress-xs progress-transparent custom-color-green mb-0 mt-3">
                                        <div class="progress-bar" data-transitiongoal="87"></div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('counsellor/enquiries');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                               <a href="<?php echo base_url('counsellor/reports/enquiries_replied');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="icon-speech text-col-green" style="font-size:25px;"></i>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('counsellor/reports/enquiries_pending');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
