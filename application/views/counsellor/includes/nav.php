 <nav class="navbar navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="navbar-brand">
                    <a href="<?php echo base_url("counsellor/dashboard");?>">
                                        ...
                                        <div class="dropdown-menu animated flipInY user-profile">
                                            ...
                                            <div class="m-t-10 p-3 drop-list">
                                                <ul class="list-unstyled">
                                                    <li><a href="<? echo base_url('counsellor/settings/basic') ?>"><i class="icon-user"></i>My Profile</a></li>
                                                    
<!--                                                    <li><a href="#"><i class="icon-settings"></i>Settings</a></li>-->
                                                    <li class="divider"></li>
                                                    <li><a href="<?php echo base_url("counsellor/login/logout");?>"><i class="icon-power"></i>Logout</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
