                        ...
                        <div class="body">
                            ...
                            <!-- <form id="basic-form" method="post" action="<?php echo base_url("expert/settings/update")?>" enctype="multipart/form-data" novalidate> -->
                              <div class="row">
                                 <div class="col-lg-6 pull-left">
                                    <div class="form-group">
                                        <label>Counsellor name</label><span style="color: red;margin-left: 10px;">*</span>
                                        <input type="text" class="form-control" name="expert_name" value="<?php if(isset($expert->expert_name)){ echo $expert->expert_name;}?>" required>
                                    </div>
                                  </div>
                                  <div class="col-lg-6 pull-left">
										 <div class="form-group">
											<label>Email Id</label><span style="color: red;margin-left: 10px;">*</span>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6 pull-left">
									<div class="form-group">
											<label>Language Spoken</label><span style="color: red;margin-left: 10px;">*</span>
                              ...
                              <div class="row">
                                 <div class="col-lg-6 pull-left">
                                        <div class="form-group">
                                    <label>Mobile Number (1) </label><span style="color: red;margin-left: 10px;">*</span>
...
<div class="row">
                                <div class="col-lg-6 pull-left">
                                    <div class="form-group">
                                        <label>Designation</label><span style="color: red;margin-left: 10px;">*</span>
                                  ...
                                  <div class="col-lg-6 pull-left">
                                     <div class="form-group">
                                        <label>Highest Educational Qualification</label><span style="color: red;margin-left: 10px;">*</span>
...
<div class="row">
                                <div class="col-lg-6 pull-left">
                                    <div class="form-group">
                                        <label>Gender</label><span style="color: red;margin-left: 10px;">*</span>
                                     ...
                                     <div class="col-lg-6 pull-left">
                                      <div class="form-group">
                                        <label>Type /Mode of Interaction preferred </label><span style="color: red;margin-left: 10px;">*</span>
                                ...
                                <div class="row">
                                  <div class="col-lg-6 pull-left">
                                     <div class="form-group">
                                        <label>Institute Name</label><span style="color: red;margin-left: 10px;">*</span>
                                    ...
                                    <div class="col-lg-6 pull-left">
                                      <div class="form-group">
                                        <label>Status</label><span style="color: red;margin-left: 10px;">*</span>
                                        <select  class="form-control" rows="5" cols="30" name="status" required>
                                             
                                            <option value="">Select</option>
                                            <option value="Active" <?php  if($expert->expert_status == "Active"){ echo "selected"; } ?>>Active</option>
                                            <option value="Inactive" <?php  if($expert->expert_status == "Inactive"){ echo "selected"; } ?>>Inactive</option>
                                        </select>
                                    </div>  
                                 ...
                                 <div class="col-lg-6 pull-left">
                                    <div class="form-group">
                                        <label>Professional Charges per Session : 30 min (Rs.)</label><span style="color: red;margin-left: 10px;">*</span>
                                        <input type="text" class="form-control" name="tcost" value="<?php if(isset($expert->expert_tcost)){ echo $expert->expert_tcost;}?>" required>
                                    </div>
                                  </div>
                                  <div class="col-lg-6 pull-left">
                                    <div class="form-group">
                                        <label>Professional Charges per Session : 60 min (Rs.)</label><span style="color: red;margin-left: 10px;">*</span>
                                   ...
                                   <div class="col-lg-6 pull-left">
                                    ...
                                    <div class="form-group">
                                        <label>Password</label><span style="color: red;margin-left: 10px;">*</span>
                                ...
                                <div class="col-lg-6 pull-left">
                                    <div class="form-group">
                                        <label>Department</label><span style="color: red;margin-left: 10px;">*</span>
                                        <input type="text" class="form-control" name="department" value="<?php if(isset($expert->expert_department)){ echo $expert->expert_department;}?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 pull-left">
                                    <div class="form-group">
                                        <label>Short Description</label><span style="color: red;margin-left: 10px;">*</span>
                                        <textarea class="form-control" rows="5" cols="30" name="shortdesc" required><?php if(isset($expert->expert_shortdesc)){ echo $expert->expert_shortdesc;}?></textarea>
                                    </div> 
                                </div>
                                <div class="col-lg-6 pull-left">
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $("#updateexpert").on('submit', function(e){
       ...
       var url = '<?php echo base_url("counsellor/settings/update")?>';
        //alert(url);
       $.ajax({
        url:url,
        data:fdata,
