	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle auth-main">
				<div class="auth-box" >
                    <div class="mobile-logo"><a href="expert/login"><img src="<?php echo base_url();?>assets/images/logo-icon.svg" alt="KAB Education Fair"></a></div>
                    <div class="auth-left">
                        <div class="left-top">
                            <a href="expert/login">
                    ...
                    <div class="auth-right">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <form id="expertlogin">
                                <!-- <form class="form-auth-small" action="<?php echo base_url("expert/login/do_login");?>" method="POST"> -->
                                    ...
                                    <div class="bottom">
                                        <span class="helper-text m-b-10"><i class="fa fa-lock"></i> <a href="<?php echo base_url('expert/login/forgot');?>">Forgot password?</a></span>
...
<script type="text/javascript">
    ...
    $("#expertlogin").on('submit', function(e){
       ...
       var url = '<?php echo base_url("professor/login/do_login") ?>';
        //alert(fdata);
       $.ajax({
        url:url,
        data:fdata,
