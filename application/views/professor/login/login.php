<?php $this->load->view("professor/includes/new_header");?>
<style>
    ...
    <a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/udema/img/logo.png" width="150px" height="55px" data-retina="true" alt=""></a>
            ...
            <div class="alert alert-danger" style="display:none" id="emsg"></div>
			  <form id="expertlogin">
				...
				<small><a href="<?php echo base_url('professor/login/forgot');?>">Forgot password?</a></small>
				<button type="submit" class="btn_1 rounded full-width add_top_60">Login</button>
				<div class="text-center add_top_10">New to Kab? <strong><a href="<?php echo base_url('professor/registration');?>">Sign up!</a></strong></div>
			</form>
