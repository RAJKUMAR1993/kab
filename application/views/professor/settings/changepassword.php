								...
								<div class="row clearfix">
									...
									<div class="col-lg-6">
                                        <div class="form-group">
											...
											<input type="text" class="form-control" name="oldpassword" value="<?php if(isset($admin->password)){ echo $this->professor_login_model->api_key_crypt($admin->password,"d");}?>" required>
...
<script type="text/javascript">
    ...
    $("#instituteUpdateDetails").on('submit', function(e){
       ...
       var url = '<?php echo base_url("professor/settings/update_password") ?>';
        //alert(fdata);
       $.ajax({
        url:url,
        data:fdata,
