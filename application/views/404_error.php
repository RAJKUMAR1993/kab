            ...
            <div class="vertical-align-middle auth-main">
                <div class="auth-box">
                    ...
                    <div class="auth-left">
                        <div class="left-top">
                            <a href="index.html">
                                <img src="<?php echo base_url();?>assets/images/load.gif" width="48" height="48" alt="KAB Education Fair">
                                <span>KAB Education Fair</span>
                            </a>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="margin-top-30">
                                    ...
                                    <a href="<?php echo base_url();?>" class="btn btn-primary"><i class="fa fa-home"></i> <span>Home</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
