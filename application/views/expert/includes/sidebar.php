                ...
                <nav id="leftsidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu <?php if($this->uri->segment(2)=="course"){echo "active";}?>" >
                        ...
                        <li <?php if($this->uri->segment(2)=="dashboard"){echo 'class="active"';}?>>
                            <a href="<?php echo base_url("expert/dashboard");?>"><i class="icon-home"></i><span>Dashboard</span></a>
                        </li>
                        <li class="middle <?php if($this->uri->segment(2)=="sessions"){echo "active";}?>">
                            <a href="<?php echo base_url("expert/sessions");?>"><i class="fa fa-list"></i><span>Sessions</span></a>
                        </li>
                        ...
                        <li class="middle <?php if($this->uri->segment(2)=="meetings"){echo "active";}?>">
                            ...
                            <ul>
                                <li <?php if($this->uri->segment(2)=="meetings"){echo 'class="active"';}?>>
                                    <a href="<?php echo base_url("expert/meetings");?>">Booked Sessions</a>
                                </li>
                               
                            </ul>
                        </li>
                        <li <?php if($this->uri->segment(2)=="calender"){echo 'class="active"';}?>>
                            <a href="<?php echo base_url("expert/calender");?>"><i class="icon-calendar"></i><span>My Calendar</span></a>
                        </li>
						<li <?php if($this->uri->segment(2)=="enquiries"){echo 'class="active"';}?>>
                            <a href="<?php echo base_url("expert/enquiries");?>"><i class="icon-pencil"></i><span>Enquiries</span></a>
                        </li>
                        <li <?php if($this->uri->segment(2)=="reports"){echo 'class="active"';}?>>
                            <a href="<?php echo base_url("expert/reports");?>"><i class="fa fa-list"></i><span>Reports</span></a>
                        </li>
                        <li class="middle <?php if($this->uri->segment(2)=="settings"){echo "active";}?>">
                            ...
                            <ul>
                                <li <?php if($this->uri->segment(3)=="basic"){echo 'class="active"';}?>>
                                    <a href="<?php echo base_url("expert/settings/basic");?>">Basic Details</a>
                                </li>
