<?php $this->load->view("expert/includes/header");?>
...
<div id="wrapper">
                ...
                <?php $this->load->view("expert/includes/nav");?>
   
                <?php $this->load->view("expert/includes/sidebar");?>

                <?php $this->load->view("expert/includes/right_sidebar");?>
                
                <?php $this->load->view("expert/".$subview) ?>

</div>



<?php $this->load->view("expert/includes/footer");?>
