...
$bgvideo = pathinfo($this->db->order_by('id', 'DESC')->get("tbl_bgvideo")->row()->file,PATHINFO_FILENAME);
...
<!--							<a href="#0" class="wish_bt"></a>-->
	...
	<? 
		$categories = $this->db->query("SELECT * from tbl_categories WHERE status='Active' and live_status='Active' and is_deleted=0")->result(); 
				...
				<div class="col-lg-8" id="faq">
					<div role="tablist" class="add_bottom_45 accordion_2" id="payment">
						<div class="card">
							<div class="card-header" role="tab">
								<h5 class="mb-0" style="color: white">
									<img src="<?php echo base_url();?>assets/animatedgifs/bullet.png" width="18px" height="15px">&nbsp;&nbsp;&nbsp;NIRF RANKED /BEST COLLEGES –SCHEDULE A MEETING
								</h5>
							</div>
						...
						<div class="card">
							<div class="card-header" role="tab">
								<h5 class="mb-0" style="color: white">
									<img src="<?php echo base_url();?>assets/animatedgifs/bullet.png" width="21px" height="18px">&nbsp;&nbsp;&nbsp;ADMISSIONS 2021 – APPLY
								</h5>
							</div>
						...
						<div class="card">
							<div class="card-header" role="tab">
								<h5 class="mb-0" style="color: white">
									<img src="<?php echo base_url();?>assets/animatedgifs/bullet.png" width="21px" height="18px">&nbsp;&nbsp;&nbsp;MERIT SCHOLARSHIP/FEE CONCESSION –EXPLORE
								</h5>
							</div>
...
<!--									<p>JoSAA ,NEET and EAMCET Web Consulting Demonstration live Interaction for doubts clarifications.</p>-->
						...
						<div class="card">
							<div class="card-header" role="tab">
								<h5 class="mb-0" style="color: white">
									<img src="<?php echo base_url();?>assets/animatedgifs/bullet.png" width="21px" height="18px">&nbsp;&nbsp;&nbsp;CAREER GUIDANCE
								</h5>
							</div>
...
<!--									<p>Guidance for JEE(Main)2020, JEE (Adv) 2020 NEET 2020 and EAMCET2020 rank holders on college selection, course Prioritization.</p>-->
						...
						<div class="card">
							<div class="card-header" role="tab">
								<h5 class="mb-0" style="color: white">
									<img src="<?php echo base_url();?>assets/animatedgifs/bullet.png" width="21px" height="18px">&nbsp;&nbsp;&nbsp;JEE(Main), NEET Exam Preparation Tips
								</h5>
							</div>
...
<!--									<p>One-to-one interaction with career advisors to shortest the career options.</p>-->
						...
						<div class="card">
							<div class="card-header" role="tab">
								<h5 class="mb-0" style="color: white">
									<img src="<?php echo base_url();?>assets/animatedgifs/bullet.png" width="21px" height="18px">&nbsp;&nbsp;&nbsp;JEE(Main), NEET Exam Study Material Download
								</h5>
							</div>
...
<!--									<p>One-to-one interaction with career advisors to shortest the career options.</p>-->
						...
						<!-- <div class="card">
							<div class="card-header" role="tab">
								<h5 class="mb-0">
									<i class="indicator ti-angle-right"></i>&nbsp;&nbsp;&nbsp;ADMISSION DOUBTS ?—GET CLARIFIACTIONS
								</h5>
							</div>
						...
						<div class="card">
							<div class="card-header" role="tab">
								<h5 class="mb-0">
									<i class="indicator ti-angle-right"></i>&nbsp;&nbsp;&nbsp;COMPITITIONS FOR GIFTS AND PRIZES  —PARTICIPATE
								</h5>
							</div>
				...
				<div class="col-lg-4 text-center">
						<img src="<?php echo base_url();?>assets/udema/img/free_reg1.PNG" class="img-fluid"><br><br>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="owl-carousel feedback-slider" align="center">
						...
						<? $testimonials = $this->db->get_where("tbl_testimonials",["is_deleted"=>0])->result(); 
