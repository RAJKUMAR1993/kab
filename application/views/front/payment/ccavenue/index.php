...
$o = $this->db->get_where("tbl_orders",array("order_id"=>$oid))->row();
$sdata = $this->db->get_where("tbl_students",array("student_id"=>$o->student_id))->row();
...
<div class="container" style="display: none">
    <div class="row">
      <div class="col-md-12">
		<form method="post" name="customerData" action="<? echo base_url() ?>front/payment/paymentRequest">

		<table width="40%" height="100" border='1' align="center">
			<table width="40%" height="100"  align="center" class="table" style="border:1px solid blue;">
				<center><h2 style="color:green;">CCavenue Payment Gateway</h2></center>
				
				<tr>
					<td>TID	:</td><td><input type="hidden" name="tid" id="tid" readonly /></td>
				</tr>
				<tr>
					<td>Merchant Id	:</td><td><input type="hidden" name="merchant_id" value="<?php echo $zdata->merchant_id; ?>"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="hidden" name="redirect_url" value="<? echo base_url() ?>front/payment/paymentResponse"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="hidden" name="cancel_url" value="<? echo base_url() ?>front/payment/paymentResponse"/></td>
			 	</tr>
			 	<tr>
