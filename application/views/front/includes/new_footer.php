...
<!--					<p><img src="img/logo.png" width="149" height="42" data-retina="true" alt=""></p>-->
		...
		<? } ?>		
				...
				<div class="col-lg-2 col-md-6">
					...
					<div class="follow_us">
                        ...
                        <ul style="display: flex;"> 
                        <br>
						<li><a href="https://www.facebook.com/sharer/sharer.php?u=<? echo $actual_link ?>&amp;src=sdkpreparse" target="_blank"><i class="ti-facebook"></i></a></li>
						<li><a href="https://twitter.com/intent/tweet?text=<? echo $actual_link ?>" target="_blank"><i class="ti-twitter-alt"></i></a></li>
						<li><a href="http://pinterest.com/pin/create/link/?url=<? echo $actual_link ?>" target="_blank"><i class="ti-pinterest"></i></a></li>
						<li><a href="https://www.linkedin.com/sharing/share-offsite/?url=<? echo $actual_link ?>" target="_blank"><i class="ti-linkedin"></i></a></li>
						
						<? if($this->session->userdata("student_id")){ ?>
							<li style="font-size: 23px;"><a href="https://api.whatsapp.com/send?phone=91<? echo $sdata->phone ?>&amp;text=<? echo $actual_link ?>" target="_blank"><i class="fa fa-whatsapp"></i></a></li>
						<? } ?>
						</ul>
					</div>
				</div>
	...
	<!-- COMMON SCRIPTS -->
<!--    <script src="<?php echo base_url();?>assets/udema/js/bootstrap.min.js"></script>-->
...
<!--    <script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>-->
	...
	<!-- SPECIFIC SCRIPTS -->
    <script src="<?php echo base_url();?>assets/udema/layerslider/js/greensock.js"></script>
    <script src="<?php echo base_url();?>assets/udema/layerslider/js/layerslider.transitions.js"></script>
    <script src="<?php echo base_url();?>assets/udema/layerslider/js/layerslider.kreaturamedia.jquery.js"></script>
	...
	$("#csend_message").submit(function(e){
		...
		e.preventDefault();
		  ...
		  $.ajax({
				...
				url: '<? echo base_url('welcome/sendmessage') ?>',
				type: 'POST',
				data: array,
...
//					$(".outgoing_msg").append('<div class="sent_msg"><p>Test which is a new approach to have allsolutions</p><span class="time_date"> 11:01 AM    |    June 9</span> </div></div>');
				...
				success: function(data) {
					...
					if(data.status == "success"){
						...
						$(".msg_history").append('<div class="outgoing_msg"><div class="sent_msg"><p>'+message+'</p><span class="time_date">'+data.time+'</span> </div></div><div class="incoming_msg"><div class="received_msg"><div class="received_withd_msg"><p>'+data.received_msg+'</p><span class="time_date">'+data.time+'</span></div></div></div>');

						$.ajax({

							type : "post",
							data : {student_message:message,institute_reply:data.received_msg},
...
$.fn.magicRatingInit = function(config) {
    ...
    for (widget of $(this)) {
        ...
        */
		...
		<div class="custom_modal" id="feedbacki" style="top: 70px">
    <div class="row">
        <div class="col-md-12 text-right">
            <a style="font-size:20px;cursor:pointer;color:red" onclick="closeModal('feedbacki');">
                <i class="icon-cancel-6"></i><p style="font-size:10px;margin-bottom: 0px">Close</p>
            </a>
        </div>
    </div>
 ...
 <div class="col-md-12">  <img src="<? echo base_url()?>assets/images/front/img_1.png" /> <p style="margin-bottom: 0px"><? echo $idata->feedback_description; ?></p></div>
  ...
  <div class="row align-items-center text-center">
   <div class="col-md-12 rate">
                  ...
                  <span style="color:#f00!important;" id="rating" class="rating" data-current-rating="0" data-icon-bad="fa fa-heart-o" data-icon-good="fa fa-heart"><i class="magic-rating-icon fa fa-heart" aria-hidden="true" data-default="false" data-rating="1"></i><i class="magic-rating-icon fa fa-heart-o" aria-hidden="true" data-default="false" data-rating="2"></i><i class="magic-rating-icon fa fa-heart-o" aria-hidden="true" data-default="false" data-rating="3"></i><i class="magic-rating-icon fa fa-heart-o" aria-hidden="true" data-default="false" data-rating="4"></i><i class="magic-rating-icon fa fa-heart-o" aria-hidden="true" data-default="false" data-rating="5"></i></span>                  
                                  ...
                                  <div align="center">
                                  <textarea name="comment" class="form-control" style="width: 60%" placeholder="Comment"></textarea>
                                </div>
                                <br/>
