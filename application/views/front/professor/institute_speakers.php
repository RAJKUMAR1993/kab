				...
				<ul class="pricing-wrapper">
					<li data-type="monthly" class="is-visible">
						<header class="pricing-header">
							<h2><?php echo $se->speaker_name; ?></h2>

							<div class="price">
								<?php if($se->speaker_photo != ""){ ?>
								<img src="<?php echo base_url();?>assets/images/professors/<?php echo $se->speaker_photo; ?>" class="img-thumbnail img-fluid" width="375px" height="450px" alt=""/>
							<?php }else{ ?>
						...
						<div class="pricing-body">
							<ul class="pricing-features">
								<li><?php echo $se->speaker_designation; ?></li>
								<li><?php echo $se->speaker_qualification; ?></li>
								<li><em>Languages  </em> <?php echo $se->speaker_spokenlang; ?></li>
								<li><em>Session Cost  </em> <? if($se->speaker_scost) { echo $se->speaker_scost;  } ?></li>
							</ul>
						</div>
						<!-- /pricing-body -->
						<footer class="pricing-footer">
							<a class="select-plan" href="<?php echo base_url();?>front/speakers/details/<?php echo $se->speaker_id; ?>">BOOK NOW</a>
						</footer>
					</li>
				</ul>
				<!-- /pricing-wrapper -->
