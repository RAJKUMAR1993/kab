				...
				<ul class="pricing-wrapper">
					<li data-type="monthly" class="is-visible">
						<header class="pricing-header">
							...
							<div class="price">
								<?php if($se->expert_photo != ""){ ?>
								<img src="<?php echo base_url();?>assets/images/professors/<?php echo $se->expert_photo; ?>" class="img-thumbnail img-fluid" width="375px" height="450px" alt=""/>
							<?php }else{ ?>
						...
						<div class="pricing-body">
							<ul class="pricing-features">
								<li><h6><?php echo $se->expert_name; ?></h6></li>
								<li><?php echo $se->expert_designation; ?></li>
								<li><?php echo $se->expert_qualification; ?></li>
								<li><em>Languages  </em> <?php echo $se->expert_spokenlang; ?></li>
								<li><em>Session Cost  </em> <? if($se->expert_scost) { echo $se->expert_scost;  } ?></li>
							</ul>
						</div>
						<!-- /pricing-body -->
						<footer class="pricing-footer">
							<a class="select-plan" href="<?php echo base_url();?>front/experts/details/<?php echo $se->expert_id; ?>">BOOK NOW</a>
						</footer>
					</li>
				</ul>
				<!-- /pricing-wrapper -->
