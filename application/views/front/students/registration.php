                ...
                <div class="row align-items-center1">
                    ...
                    <div class="col-12 col-md-7 col-lg-6">
                        <div class="home-intro"><br/>
                            ...
                            <form id="studentreg">
                           <!-- <form id="basic-form" method="post" action="<?php echo base_url("front/students/save_student/");?>" novalidate> -->
                        <div class="row mt-4 text-white">
                           ...
                           <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" rows="5" cols="30" name="address" required></textarea>
                            </div>
...
<div class="col-md-6 log">Have an account? <a href="<? echo base_url().'student/login'?>"> Login </a> </div>
...
<script type="text/javascript">
    ...
    $("#studentreg").on('submit', function(e){
       ...
       var url = '<?php echo base_url("front/students/save_student/") ?>';
        //alert(fdata);
       $.ajax({
        url:url,
        data:fdata,
