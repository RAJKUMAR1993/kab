	  ...
	  <?php foreach($sessions as $se){ ?>
			...
			<li class="col-12 col-md-6 col-lg-3">
					  <div class="cnt-block equal-hight" >
						...
						<h3><a href="#"><?php echo $se->expert_name; ?></a></h3>
						<p><?php echo $se->expert_designation; ?></p>
						 <div class="line1"></div>
					   <p> <?php echo $se->expert_qualification; ?></p>
						<div class="line1"></div>
						<p>Language Spoken: <?php echo $se->expert_spokenlang; ?></p>
					   
					   <div class="cd">
					   <h4> <?php echo $se->expert_tcost; ?></h4>
			<p>for 30 Minutes session</p> 
			</div>  
			<a href="<?php echo base_url();?>exhibitors/profile/<?php echo $se->expert_id; ?>"><button class="btn btn-danger btn-block">BOOK NOW</button></a>         
					  </div>
				  </li>
