                ...
                <div class="row align-items-center1">
                    ...
                    <div class="col-12 col-md-7 col-lg-6">
                        <div class="home-intro"><br/>
                            <h1 class="text-white">Institute Verification </h1>
                            <p><? echo 'We Have Sent OTP to '.'<strong>'.$this->session->userdata("phone").'</strong>' ?></p>
                            <p><?php echo $this->session->flashdata('msg');?> </p>
<div class="alert alert-success" style="display:none" id="smsg"></div>
 <div class="alert alert-danger" style="display:none" id="emsg"></div>
 <form id="instituteVerifyOTP">
 <!-- <form id="basic-form" method="post" action="<?php echo base_url("front/institutes/otp_verify_institute/");?>" novalidate> -->
    <div class="row mt-4 text-white">
                    <input type="hidden" class="form-control" name="mobile" value="<? echo $this->session->userdata('phone');?>">
					<input type="hidden" class="form-control" name="i_name" value="<? echo $this->session->userdata('i_name');?>">
                    ...
                    <div class="col-md-12">
                        <div id="countdown" class="alert"></div>
                                <div class="row">
                                    ...
                                    <? //} ?>
                                 	<div class="col-md-4">  
                                    	<a href="<? echo base_url('institute/registration') ?>" class="btn btn-warning float-right"><i class="fa fa-chevron-left"></i> Back</a>
                                	</div>
                                	<div class="col-md-2">  
...
<script type="text/javascript">
    ...
    $("#instituteVerifyOTP").on('submit', function(e){
       e.preventDefault();
       var fdata = $("#instituteVerifyOTP").serialize();
       var url = '<?php echo base_url("front/institutes/otp_verify_institute/") ?>';
        //alert(fdata);
       $.ajax({
        url:url,
        data:fdata,
...
<script type="text/javascript">
    $("#resend").click(function(e) {
        ...
        $.ajax({
          url:"<?php echo base_url("front/institutes/resend_OTP/");?>",
          data: {"mobile":mobile},
          type:"post",
          dataType:"json",
          success:function(str){
