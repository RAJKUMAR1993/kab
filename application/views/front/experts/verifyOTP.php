                ...
                <div class="row align-items-center1">
                    ...
                    <div class="col-12 col-md-7 col-lg-6">
                        <div class="home-intro"><br/>
                            <h1 class="text-white">Expert Verification </h1>
                            <p><?php echo $this->session->flashdata('msg');?> </p>
                            <div class="alert alert-danger" style="display:none" id="emsg"></div>
                            <div class="alert alert-success" style="display:none" id="smsg"></div>
<form id="studentVerifyOTP">
    <div class="row mt-4 text-white">
                    <input type="hidden" class="form-control" name="mobile" value="<? echo $this->session->userdata('e_phone');?>">
					<input type="hidden" class="form-control" name="e_name" value="<? echo $this->session->userdata('e_name');?>">
                                    ...
                                    <? //if($this->session->flashdata('msg')){ ?>
                                        <div class="col-md-6">
                                            ...
                                            <div id="resenddiv" style="display:none">
                                                <a id="resend" rmobile="<? echo $this->session->userdata('e_phone');?>" class="btn btn-success">Resend</a>
                                            </div>
                                        </div>
                                    <? //} ?>
                                 <div class="col-md-6">  
...
<script type="text/javascript">
    ...
    $("#studentVerifyOTP").on('submit', function(e){
       ...
       var url = '<?php echo base_url("front/experts/otp_verify_expert/") ?>';
        //alert(fdata);
       $.ajax({
        url:url,
        data:fdata,
...
<script type="text/javascript">
    $("#resend").click(function(e) {
        ...
        $.ajax({
          url:"<?php echo base_url("front/experts/resend_OTP/");?>",
          data: {"mobile":mobile},
          type:"post",
          dataType:"json",
          success:function(str){
