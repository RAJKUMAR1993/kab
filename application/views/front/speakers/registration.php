		...
		<aside>
            ...
            <div class="alert alert-danger" style="display:none" id="emsg"></div>
			  <form id="studentreg">
				...
				<div class="text-center add_top_10">Have an account? <strong><a href="<?php echo base_url('speaker/login');?>">Login</a></strong></div>
			</form>
...
<script type="text/javascript">
    ...
    $("#studentreg").on('submit', function(e){
       ...
       var url = '<?php echo base_url("front/speakers/save_speaker/") ?>';
       $.ajax({
        url:url,
        data:fdata,
        type:"post",
