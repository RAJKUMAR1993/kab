                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-title" align="center">
                            <h4>Students Visited E Booth's</h4>
                            <a href="<? echo base_url('institute/analytics') ?>" class="btn btn-info btn-rounded pull-right" style="margin-right: 10px;margin-top: -30px;"><i class="fa fa-chevron-left"></i> Analytics</a>
                        </div>
                        ...
                        <div class="row" style="margin-left: 5px;">   
					      ...
					      <div class="col-md-2">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <a href="<? echo base_url('institute/analytics/svebooth') ?>" class="btn btn-primary" style="margin-top: 25px">Clear</a>
                                </div>
                                </form>
                            </div>
...
function filter(sdate="",edate="",location=""){
	...
	var table = $('#zero_config').dataTable({
         "bProcessing": true,
         "ajax": {
			"url": "<?php echo base_url("institute/analytics/filtersvebooth") ?>",
			"type": "POST",
