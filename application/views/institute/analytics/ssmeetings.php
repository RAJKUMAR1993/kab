                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-title" align="center">
                            <h4>Students Scheduled Meetings</h4>
                            ...
                            <table class="table table-bordered table-striped table-hover" id="zero_config" width="100%">
                                <thead>
                                    <tr> 
                                        ...
                                        <th height="30px" width="50px">Student Join Time</th>
                                        <th height="30px" width="50px">Student Leave Time</th>
<!--                                        <th height="30px" width="50px">Student Mobile</th>-->
                                        <th height="30px" width="50px">Professor Name</th>
                                        <th height="30px" width="50px">Professor Dept</th>
                                        <th height="30px" width="50px">Date</th>
                                        <th height="30px" width="50px">Session Start Time</th>
                                        <th height="30px" width="50px">Session End Time</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
function filter(sdate="",edate=""){
	...
	var table = $('#zero_config').dataTable({
         "bProcessing": true,
         "ajax": {
			"url": "<?php echo base_url("institute/analytics/filterssmeetings") ?>",
			"type": "POST",
