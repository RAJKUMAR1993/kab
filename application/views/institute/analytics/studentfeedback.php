                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-title" align="center">
                            <h4>Feedback Given By Students</h4>
                            ...
                            <table class="table-bordered table-striped table-hover" id="zero_config" width="100%">
                                <thead>
                                    <tr> 
                                        ...
                                        <th height="30px" width="50px">Comment</th>
                                        <th height="30px" width="50px">Rating</th>
...
function filter(sdate="",edate=""){
	...
	var table = $('#zero_config').dataTable({
         "bProcessing": true,
         "ajax": {
			"url": "<?php echo base_url("institute/analytics/filterstudentfeedback") ?>",
			"type": "POST",
