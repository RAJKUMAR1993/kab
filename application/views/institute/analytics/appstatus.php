                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-title" align="center">
                            <h4>Application Status Of Students</h4>
...
<!--                                        <th height="30px" width="50px">Student Mobile</th>-->
                                        ...
                                        <th height="30px" width="50px">Course</th>
                                        <th height="30px" width="50px">Specialization</th>
                                        <th height="30px" width="50px">Merit Scholarship</th>
...
function filter(sdate="",edate=""){
	...
	var table = $('#zero_config').dataTable({
         "bProcessing": true,
         "ajax": {
			"url": "<?php echo base_url("institute/analytics/filterappstatus") ?>",
			"type": "POST",
