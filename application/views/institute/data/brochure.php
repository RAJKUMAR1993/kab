				...
				<div class="modal-content">
				 ...
				 <div class="modal-header">
				  ...
				  <div class="modal-body">    
					  <input type="hidden" id="url" name="url" value="<?php echo base_url("institute/data/add_brochure");?>">
					  ...
					  <div class="form-group">
						<label for="inputPassword3" class="col-form-label">Brochure</label>
						  ...
						  <input type="file" class="form-control"  name="picture" accept="application/pdf" required>
			...
			<div class="modal fade" id="updateModal" role="dialog">
						...
						<div class="alert alert-danger" style="display:none" id="eumsg"></div>
							  ...
							  <div class="modal-body">
								  ...
								  <div class="form-group">
									<label for="inputPassword3" class="col-form-label">Brochure</label>
									  <input type="file" class="form-control"  name="picture" accept="application/pdf">
						  <small style="color: red">Note : Maximum File size of pdf should be less than 1MB</small>
