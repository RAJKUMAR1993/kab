                    ...
                    <div class="card">
                        <div class="header webinarHeader1">
                            ...
                            <div class="col-lg-1 pull-right">
                                <a href="<?php echo base_url("institute/faqs");?>" class="btn btn-info">Back</a>
                            </div>
                        ...
                        <div class="body">
                            ...
                            <form id="addeditwebinor">
                                <input type="hidden" id="url" name="url" value="<?php echo base_url("institute/faqs/save_faq/".$this->uri->segment(4));?>">
