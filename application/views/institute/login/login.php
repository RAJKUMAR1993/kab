	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle auth-main">
				<div class="auth-box" >
                    <div class="mobile-logo"><a href="institute/login"><img src="<?php echo base_url();?>assets/images/logo-icon.svg" alt="KAB Education Fair"></a></div>
                    <div class="auth-left">
                        <div class="left-top">
                            <a href="admin">
                    ...
                    <div class="auth-right">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <!-- <form class="form-auth-small" action="<?php echo base_url("institute/login/do_login");?>" method="POST"> -->
                                    ...
                                    <div class="bottom">
                                        <span class="helper-text m-b-10"><i class="fa fa-lock"></i> <a href="<?php echo base_url('institute/login/forgot');?>">Forgot password?</a></span>
                                        <span>Don't have an account? <a href="<?php echo base_url('institute/registration');?>">Register</a></span>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    //Login Service
    $("#institutelogin").on('submit', function(e){
       e.preventDefault();
       var fdata = $("#institutelogin").serialize();
       var url = '<?php echo base_url("institute/login/do_login") ?>';
        //alert(fdata);
       $.ajax({
        url:url,
        data:fdata,
