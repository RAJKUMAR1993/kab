	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle auth-main">
				<div class="auth-box">
                    <div class="mobile-logo"><a href="<?php echo base_url('institute/login');?>"><img src="<?php echo base_url();?>assets/images/logo-icon.svg" alt="Mplify"></a></div>

                    <div class="auth-left">
                        <div class="left-top">
                            <a href="<?php echo base_url('institute/login');?>">
                    ...
                    <div class="auth-right">
                        <div class="right-top">
                            <ul class="list-unstyled clearfix d-flex">
                                <li><a href="<?php echo base_url('institute/login');?>"><i class="fa fa-home"></i></a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <!-- <form class="form-auth-small" action="<?php echo base_url('institute/login/reset_password');?>" method="POST"> -->
                                    ...
                                    <div class="bottom">
                                        <span class="helper-text">Know your password? <a href="<?php echo base_url('institute/login');?>">Login</a></span>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $("#forgotpassword").on('submit', function(e){
       ...
       var url = '<?php echo base_url("institute/login/reset_password") ?>';
        //alert(fdata);
       $.ajax({
        url:url,
        data:fdata,
