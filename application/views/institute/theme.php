<?php $this->load->view("institute/includes/header");?>
...
<div id="wrapper">
                ...
                <?php $this->load->view("institute/includes/nav");?>
   
                <?php $this->load->view("institute/includes/sidebar");?>

                <?php $this->load->view("institute/includes/right_sidebar");?>
                <?php //$this->load->view("admin/dashboard/dashboard");?>
                <?php $this->load->view("institute/".$subview) ?>

</div>



<?php $this->load->view("institute/includes/footer");?>
