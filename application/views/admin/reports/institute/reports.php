                    ...
                    <form>
                    	<div class="form-group">
                    		<select class="form-control" name="institute_id">
                    			...
                    			<? $institutes = $this->db->get_where("tbl_institutes",["is_deleted"=>0])->result(); 
									foreach($institutes as $ins){
										echo '<option value="'.$ins->institute_id.'">'.$ins->institute_name.'</option>';
									}
								?>
                ...
                <div class="col-12">
                    <div class="card top_report">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('institute/sessions/auditorium_video_presentations');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                               <a href="<?php echo base_url('institute/feedback');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-comments-o text-col-green"></i>
                                        </div>
                                        <div class="number float-right text-right">
                                            <h6>Feedback</h6>
