                    ...
                    <div class="card top_report">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/total_professor_sessions');?>">
                                <div class="body">
                                    <div class="clearfix">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/total_professor_meetings');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-comments-o text-col-blue" style="font-size:25px;"></i>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/sessions_professor_completed');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-comments-o text-col-blue" style="font-size:25px;"></i>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/sessions_professor_tobecompleted');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/enquiries_professor');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                               <a href="<?php echo base_url('admin/reports/enquiries_replied_professor');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="icon-speech text-col-green" style="font-size:25px;"></i>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/enquiries_pending_professor');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
