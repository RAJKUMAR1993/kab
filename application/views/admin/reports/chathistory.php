									...
									<table class="table table-bordered table-striped table-hover chatdataTable dataTable">
										...
										<tbody>
											...
											if($chat){
													$key=1;
													foreach($chat as $row):
														$sname = json_decode($row->student_data);
												?>
											<tr>
												<td><?php echo $key;?></td>
												...
												<td><?php echo date("d-m-Y",strtotime($row->date)) ?></td>
												 <td>
													...
													<a href="<? echo base_url('admin/reports/getChat/').$row->student_id ?>" data-toggle="tooltip" title="Export Chat" style="margin:0px 20px 0px 20px"><i class="fa fa-cloud-download"></i></a>
												</td>
											</tr>
											<?php $key++; endforeach;}
