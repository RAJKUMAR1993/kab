                    ...
                    <div class="card top_report">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/expert_reports');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-users text-col-blue" style="font-size:25px;"></i>
                                        </div>
                                        <div class="number float-right text-right">
                                            <h6>Expert Councellors</h6>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/speaker_reports');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-users text-col-green" style="font-size:25px;"></i>
                                        </div>
                                        <div class="number float-right text-right">
                                            <h6>Eminent Speakers</h6>
                                        </div>
                                    </div>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/professor_reports');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-users text-col-yellow" style="font-size:25px;"></i>
                                        </div>
                                        <div class="number float-right text-right">
                                            <h6>Professors</h6>
                                        </div>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/counsellor_reports');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-users text-col-green" style="font-size:25px;"></i>
                              ...
                              <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/chathistory');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="icon-speech text-col-blue" style="font-size:25px;"></i>
                                        </div>
                                        <div class="number float-right text-right">
                                            <h6>Chat</h6>
                                        </div>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/auditorium/auditorium_presentations');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-building text-col-red" style="font-size:25px;"></i>
                                        </div>
                                        <div class="number float-right text-right">
                                            <h6>Auditoriums</h6>
                                        </div>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                ...
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-building text-col-yellow" style="font-size:25px;"></i>
                                        </div>
                                        <div class="number float-right text-right">
                                            <h6>Webinars</h6>
                                        </div>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/instituteReports');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
