        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">                        
                    <h2>Institute Professors Reports</h2>
                    <a href="<?php echo base_url("admin/reports");?>"><button type="button" class="btn btn-primary btn-block col-lg-2 pull-right"  data-target="#addevent">Reports</button></a> <br>
                </div>
            </div>
        </div>
                    ...
                    <div class="card top_report">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/total_counsellor_sessions');?>">
                                <div class="body">
                                    <div class="clearfix">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/total_counsellor_meetings');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-comments-o text-col-blue" style="font-size:25px;"></i>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/sessions_counsellor_completed');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-comments-o text-col-blue" style="font-size:25px;"></i>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/sessions_counsellor_tobecompleted');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/enquiries_counsellor');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                               <a href="<?php echo base_url('admin/reports/enquiries_replied_counsellor');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="icon-speech text-col-green" style="font-size:25px;"></i>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/enquiries_pending_counsellor');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
