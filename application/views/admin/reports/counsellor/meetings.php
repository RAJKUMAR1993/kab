                    ...
                    <div class="card">
                        <div class="header">
                            <div class="col-lg-12 pull-left">
	                            ...
	                            <a href="<?php echo base_url("admin/reports/counsellor_reports");?>"><button type="button" class="btn btn-primary btn-block col-lg-3 pull-right"  data-target="#addevent">Institute Professor Reports</button></a> <br><br>
                            </div>
