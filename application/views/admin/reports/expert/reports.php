        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">                        
                    <h2>Expert Councellor Reports</h2>
                    ...
                    <div class="card top_report">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/total_sessions');?>">
                                <div class="body">
                                    <div class="clearfix">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/total_meetings');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-comments-o text-col-blue" style="font-size:25px;"></i>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/sessions_completed');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="fa fa-2x fa-comments-o text-col-blue" style="font-size:25px;"></i>
                             ...
                             <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/sessions_tobecompleted');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/enquiries');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                               <a href="<?php echo base_url('admin/reports/enquiries_replied');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                            <i class="icon-speech text-col-green" style="font-size:25px;"></i>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <a href="<?php echo base_url('admin/reports/enquiries_pending');?>">
                                <div class="body">
                                    <div class="clearfix">
                                        <div class="float-left">
