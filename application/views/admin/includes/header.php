...
<link rel="stylesheet" href="<?php echo base_url();?>assets/vendor/bootstrap-dastepicker/css/bootstrap-datepicker3.min.css">
...
<!-- Summer note , add course -->
<link rel="stylesheet" href="<?php echo base_url();?>assets/vendor/summernote/dist/summernote.css"/>

<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>

<link href="<? echo base_url('assets/') ?>css/bootstrap-switch.min.css" rel="stylesheet">
<link href="https://cdn.jsdelivr.net/gh/lykmapipo/themify-icons@0.1.2/css/themify-icons.css" rel="stylesheet">
<script src="<? echo base_url('assets/') ?>js/bootstrap-switch.min.js" ></script>
