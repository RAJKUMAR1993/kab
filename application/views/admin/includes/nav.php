            ...
            <div class="container-fluid">
                ...
                <div class="navbar-brand">
                    <a href="<?php echo base_url("admin/dashboard");?>">
                        <img src="<?php echo base_url();?>assets/images/svg.png" alt="KABEFO" class="img-responsive logo">
                                        ...
                                        <div class="dropdown-menu animated flipInY user-profile">
                                            <div class="d-flex p-3 align-items-center">
                                                ...
                                                <div class="drop-right">
                                                    ...
                                                    <p class="user-name"><?php echo $this->session->userdata('admin_email');?></p>
                                                </div>
                                            </div>
                                            <div class="m-t-10 p-3 drop-list">
                                                <ul class="list-unstyled">
                                                    <li><a href="<?php echo base_url('admin/settings/basic');?>"><i class="icon-user"></i>My Profile</a></li>
                                                    <!-- <li><a href="app-inbox.html"><i class="icon-envelope-open"></i>Messages</a></li> -->
                                                    <!--<li><a href="<?php echo base_url('admin/settings/basic');?>"><i class="icon-settings"></i>Settings</a></li>-->
													<li><a href="<?php echo base_url(); ?>admin/settings/changepassword"><i class="icon-key"></i>Change Password</a></li>
                                                    <li class="divider"></li>
