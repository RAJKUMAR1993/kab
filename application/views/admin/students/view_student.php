                    ...
                    <div class="card">
                        <div class="header">
							...
							<div class="col-lg-4 pull-right">
                            	<a href="<?php echo base_url(); ?>admin/students/createPDF/<?php echo $student->std_id;  ?>" target="_blank" ><button class="btn btn-primary">Download</button></a>&nbsp;&nbsp;&nbsp;<button class="btn btn-primary cprintTable">Print</button>&nbsp;&nbsp;&nbsp;
                            	<a href="<?php echo base_url(); ?>admin/students"><button class="btn btn-info"><i class="fa fa-chevron-left"></i>  Back</button></a>
                            </div>
                            </div>                  
                        </div>
