	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle auth-main">
				<div class="auth-box">
                    <div class="mobile-logo"><a href="<?php echo base_url('admin');?>"><img src="<?php echo base_url();?>assets/images/logo-icon.svg" alt="Mplify"></a></div>
                    ...
                    <div class="auth-right">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <!-- <form class="form-auth-small" action="<?php echo base_url('admin/login/reset_password');?>" method="POST"> -->
                                    ...
                                    <div class="bottom">
                                        <span class="helper-text">Know your password? <a href="<?php echo base_url('admin');?>">Login</a></span>
                                    </div>
                                </form>
                            </div>
                        </div>
