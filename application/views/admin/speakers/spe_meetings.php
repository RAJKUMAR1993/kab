                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if(date('Y-m-d H:i:s', strtotime('+ '.$row->spe_std_duration.' minutes', $row->spe_std_time)) >= date("Y-m-d H:i:s")){ echo $row->zoom_link; }else{ echo '<p style="color: red;">Meeting Time has beed completed.</p>';}?></td>
